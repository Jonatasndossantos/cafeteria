...
// MOCKS E CONSTANTES
const details = {
  receitaBase: 45200000,
  despesaMDE: 12103000,
  percentual: 26.8,
  minimo: 25.0,
  status: "Conforme",
  fonte: "Art. 212 da Constituição Federal",
};

const evolucaoMensal = [
  { mes: "Jan", percentual: 14.2 },
  { mes: "Fev", percentual: 18.1 },
  { mes: "Mar", percentual: 20.6 },
  { mes: "Abr", percentual: 22.7 },
  { mes: "Mai", percentual: 23.9 },
  { mes: "Jun", percentual: 24.8 },
  { mes: "Jul", percentual: 25.4 },
  { mes: "Ago", percentual: 25.9 },
  { mes: "Set", percentual: 26.3 },
  { mes: "Out", percentual: 26.5 },
  { mes: "Nov", percentual: 26.7 },
  { mes: "Dez", percentual: 26.8 },
];

const analiseQualidade = [
  {
    label: "Despesas em ensino (função 12)",
    valor: "87%",
    badge: "success",
    descricao: "da aplicação está vinculada a ensino",
    icon: "check",
  },
  {
    label: "Despesas administrativas ou apoio",
    valor: "13%",
    badge: "warning",
    descricao: "é administrativa ou apoio — verificada IA-LUX",
    icon: "alert-triangle",
  },
  {
    label: "Glosa",
    valor: "Nenhuma",
    badge: "success",
    descricao: "despesa glosada identificada",
    icon: "check-circle",
  },
];
...
// Mapeamento de ícones (nome string para componente)
// Apenas usando ícones permitidos pela policy
const iconMap = {
  check: Check,
...
export function AplicacaoEducacaoCard() {
  ...
  return (
    <Card className="dashboard-card">
      <CardHeader className="pb-4 flex flex-row items-start justify-between">
        <div>
          <CardTitle>Aplicação em Educação</CardTitle>
        </div>
              ...
              <div className="mt-6 grid gap-8">
                ...
                <section>
                  ...
                  <Table>
                    <TableBody>
                      ...
                      <TableRow>
                        <TableHead>Despesa computada (MDE)</TableHead>
                        <TableCell>{formataMoeda(details.despesaMDE)}</TableCell>
                      </TableRow>
                      <TableRow>
                  ...
                  <div style={{ height: 260 }} className="bg-slate-50 rounded-lg border border-slate-200 px-2 py-2">
                    <ResponsiveContainer width="100%" height="100%">
                      <RechartsLineChart data={evolucaoMensal}>
                        ...
                        <ReferenceLine y={25} label="Meta 25%" stroke="#fbbf24" strokeDasharray="4 4" />
                ...
                <section>
                  <h4 className="font-semibold text-md mb-2 text-lumen-blue flex items-center gap-2">
                    ...
                    Execução Programática da Educação (top 3 ações)
                  </h4>
                  <Table>
                    <TableHeader>
                      <TableRow>
                  ...
                  <div className="p-4 rounded-lg bg-yellow-50 border border-yellow-200 flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-yellow-800">
                        "A execução da educação está regular, mas ações estruturais como reformas estão abaixo de 50%. Mantenha atenção no cronograma físico-financeiro."
                      </div>
